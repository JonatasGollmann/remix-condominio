...
export default function New() {
  return (
    <div className="  w-screen h-screen bg-gradient-to-tr from-slate-100 to-slate-300 font-outfit flex flex-col items-center justify-center">
      <Link
        className=" text-custom-b2 h-8 w-8 mb-2 -ml-80 hover:text-custom-b0"
        to={"/."}
      >
        <svg
      ...
      <div className="bg-gradient-to-bl to-custom-b0 from-custom-b2  w-[450px] rounded-lg py-8 px-10 shadow-xl">
        <div>
          <img src={icon} alt="" className="h-10 mx-auto" />
          <h1 className="text-custom-y1 tracking-wider text-2xl font-bold start mt-8">
            Bem-vindo ao Dwell
          </h1>
          <p className="text-custom-w1 text-sm w-5/6 mb-2">
            Preencha as informações abaixo para acessar seu condomínio.
          </p>
          <p className="text-custom-w1 font-light">
            Já possuí conta?
            <Link
              to={"/login"}
              className="ml-2 underline decoration-custom-y1 decoration-2 underline-offset-2 font-bold hover:text-custom-y1 hover:underline-offset-4"
            >
              Faça o Login.
            </Link>
          </p>
        ...
        <Form className="mt-10">
          <div className="my-4">
            <label
              className="block text-custom-w1 text-sm mb-2"
              htmlFor="login"
            >
              Login:
            </label>
